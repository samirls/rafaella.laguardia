          ...
          <SwiperSlide>
            <Box position="relative">
              ...
              <Text
                ...
                p={2}
              >
                Consultas regulares para garantir que seu filho cresça saudável
          ...
          <SwiperSlide>
            <Box position="relative">
              ...
              <Text
                ...
                p={2}
              >
                Dicas práticas para uma alimentação equilibrada desde os
                primeiros anos.
              </Text>
            </Box>
          </SwiperSlide>
          ...
          <SwiperSlide>
            <Box position="relative">
              ...
              <Text
                ...
                p={2}
              >
                Apoio nos primeiros cuidados com o bebê, sono, amamentação e
                rotina.
              </Text>
            </Box>
          </SwiperSlide>
          ...
          <SwiperSlide>
            <Box position="relative">
              ...
              <Text
                ...
                p={2}
              >
                Avaliação da saúde física e emocional para melhor rendimento nos
                estudos.
              </Text>
            </Box>
          </SwiperSlide>
          ...
          <SwiperSlide>
            <Box position="relative">
              ...
              <Text
                ...
                p={2}
              >
                Acompanhamento para evitar problemas respiratórios, alergias,
                infecções...
              </Text>
            </Box>
          </SwiperSlide>
          ...
          <SwiperSlide>
            <Box position="relative">
              ...
              <Text
                ...
                p={2}
              >
                Cada consulta é feita com paciência, escuta ativa e acolhimento
          ...
          <SwiperSlide>
            <Box position="relative">
              ...
              <Text
                ...
                p={2}
              >
                Consultas que cuidam da saúde física e emocional nessa fase de
                tantas mudanças.
              </Text>
            </Box>
          </SwiperSlide>
          ...
          <SwiperSlide>
            <Box position="relative">
              ...
              <Text
                ...
                p={2}
              >
                Quando surgem febres, tosse ou dúvidas inesperadas, você pode
                contar com apoio rápido.
              </Text>
            </Box>
          </SwiperSlide>
        </Swiper>
